...
<!--       <h5><span class="label label-danger">Food</span> <span class="label label-primary">Ipsum</span></h5><br> -->
  ...
  <div style=" vertical-align: middle;text-align:vertical-align;">
    ...
    <div class="col-xs-7 form-horizontal">
        ...
        <input class="form-control" id="username" type="text" placeholder="아이디를 입력해 주세요" name="username">
			
     </div>
     		</div>	

			<input type="button" class="btn btn-danger btn-lg" value="비밀번호 찾기" onclick="gofindpw()"/>
		</form>
</div>
