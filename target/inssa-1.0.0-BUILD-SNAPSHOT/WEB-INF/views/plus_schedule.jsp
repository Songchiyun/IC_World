				...
				<div id="my_info">
							<div class="col-xs-8 " style="margin-left: 30%;margin-bottom: 3%;">
									<div class="form-group col-xs-7">
										<label>타이틀</label> <input type="text" class="form-control" name="title"/>
									</div>
									<div class="form-group col-xs-7">
										<label>시작 날짜</label> <input type="date" name="start_date" class="form-control"/>
									</div>
									<div class="form-group col-xs-7">
										<label>시작 시간</label> <input type="time" name="start_time" class="form-control"/>
									</div>
									<div class="form-group col-xs-7">
										<label>끝나는 날짜</label> <input type="date" name="end_date" class="form-control"/>
									</div>
									<div class="form-group col-xs-7">
										<label>끝나는 시간</label> <input type="time" name="end_time" class="form-control"/>
									</div>
							</div>
